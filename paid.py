...
┃\033[1;93mall hetters your papa devil omi is back 
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ DARK  ━━━━━━━━━━━━━━━━━┑
               \033[1;93mCREATED BY   :  DARK DEVIL OMI         
               \033[1;93mFACEBOK      :  ছো্ঁট্ঁ ন্ঁবা্ঁব্ঁ          
               \033[1;93mGITHUB       :  ERROR     
               \033[1;93mSTATUS       :   PAID😴            
               \033[1;93mTEAM         :  TEAM XUDE NA                 
               \033[1;93mTOOL VIRSION :  4.5                  
               \033[1;93mTOOL WORK    :    DATA+WIFI     
      └━━━━━━━━━━━━━━━━━ DEVIL ━━━━━━━━━━━━━━━━━┘
""")
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/DARKDEVIL19/paid/blob/main/aprovel.txt').text
    if id in httpCaht:
      ...
      print("\33[1;37m----------------------------------------------")
      print("\33[1;37mFor 15 Days Approval Price 400Tk One Month Price800  Tk")
      print('BKASH PERSONAL - +8801406115895')
      print('Send Pay And Give Ss And Send Me Key Or Ss Me Whatsapp')
      print('\33[1;37m----------------------------------------------')
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801406115895?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
...
def menu():
	...
	if ot == '1':
		os.system('xdg-open https://www.facebook.com/papar.link.copy.coro.knk')
		crack_file()
...
def menu1():
	...
	if ot == '1':
		...
		crack_file()
	if ot == '2':
		os.system('xdg-openhttps://www.facebook.com/papar.link.copy.coro.knk')
		rndm()
	if ot == '3':
		os.system('xdg-open https://www.facebook.com/papar.link.copy.coro.knk')
